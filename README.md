...
| **기획력 및 실무 접합성** | 팀 과제 운영·부가 도구·내보내기·응답 **`practical_toolkit`**(교육자 검수 체크리스트)·웹 **데모 데이터 입력** |
| **창의성** | 기여–결과 **불일치**, **협업 네트워크**, 역할 4유형, **고급 이상 탐지**, **창의 인사이트**·**팀 협업 건강도**·**가상 시뮬레이터** |
| **AI 효율 (추가)** | OpenAI 호출 **`OPENAI_TIMEOUT_SEC`**(기본 120초)로 대기 상한 |
